...
config :todo_list, TodoListWeb.Guardian,
  issuer: "todo_list",
  secret_key: "RBegNBpU0mIwoAN1mK3quKnwwrjTpYgjc6FhHI2HkBQMz/1+T7+lGwoV/1ehwfH+" # paste input here
...
config :todo_list, TodoListWeb.Endpoint,
  ...
  live_view: [signing_salt: "ai6WhgZc"]
